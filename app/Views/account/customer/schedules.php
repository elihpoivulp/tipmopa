            ...
            <div class="col-lg-12">
                <div class="card recent-sales overflow-auto">
                    ...
                    <div class="card-footer">
                        ...
                        <?php if ($filtered): ?>
                            <a href="<?= url_to('customer-schedules'); ?>" class="btn float-end btn-primary">Show Today Only</a>
                        <?php else: ?>
                            <a href="<?= url_to('customer-schedules'); ?>?all_time=true" class="btn float-end btn-primary">Show All Time</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
