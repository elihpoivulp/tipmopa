                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        ...
                                        <span class="text-muted small pt-2 ps-1"><a href="<?= url_to('operator-sales'); ?>">See All</a></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        ...
                                        <span class="text-muted small pt-2 ps-1"><a href="<?= url_to('operator-customer-list'); ?>">See All</a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
